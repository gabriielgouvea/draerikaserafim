            ...
            <div className="flex flex-col gap-2.5">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-white/65 text-sm hover:text-gold-light transition-colors duration-200 flex items-center gap-1.5 group"
                >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-white/70 text-sm hover:text-gold-light transition-colors duration-200 mt-1"
              >
